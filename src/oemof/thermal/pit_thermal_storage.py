...
"""
This module is designed to hold functions for calculating pit thermal
storages.
...
oemof-thermal/src/oemof/thermal/pit_thermal_storage.py
...
def calculate_capacities(
    ...
    and maximum storage level of a pit thermal storage.
...
def calculate_losses(
    ...
    r"""
    Calculates loss rate and fixed losses for a pit thermal storage.
